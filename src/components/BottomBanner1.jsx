...
const BottomBanner1 = () => {
  return (
    <>
        <Flex background={"#F3F3F3"} padding={"100px 20%"} flexDir={"column"} justifyItems={"center"} alignItems={"center"}>
            <Text color={primaryColor} fontSize={"30px"} fontWeight={600} textAlign={"center"} >
